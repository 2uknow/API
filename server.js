...
import { nowInTZString, kstTimestamp } from './src/utils/time.js';
import { debugLog, batchLog, matchPattern } from './src/utils/debug.js';
import { stateClients, logClients, unifiedClients, logBuffer, broadcastTimeoutId, BATCH_SIZE, BATCH_INTERVAL, recentLogHistory, MAX_LOG_HISTORY, sseHeaders, broadcastState, broadcastLog, flushLogBuffer } from './src/utils/sse.js';
import { state, registerRunningJob, unregisterRunningJob, broadcastRunningJobs, finalizeJobCompletion } from './src/state/running-jobs.js';
import { histRead, histWrite } from './src/services/history-service.js';
import { splitLargeLogs, archiveOldLogs, cleanupOldArchives, cleanupOldReports, initLogManagement } from './src/services/log-manager.js';
import { parseNewmanResult, parseNewmanJsonReport, parseNewmanCliOutput, parseNewmanOutput, generateSummary } from './src/parsers/newman-parser.js';
import { parseBinaryOutput } from './src/parsers/binary-parser.js';
import { decodeUrlEncodedContent, decryptDanalCreditResponse, processResponseBody, decodeQueryStringValues, decodeUrlEncodedValue } from './src/utils/crypto.js';
import { sendAlert, buildNewmanFailureReport, buildBinaryFailureReport, buildYamlScenarioFailureReport, buildBatchFailureReport } from './src/services/alert-integration.js';
import { schedules, loadSchedules, saveSchedules, processSchedule } from './src/services/schedule-service.js';
import { getTodayStatsInternal, getJobServiceMap, sendDailyReport, setupDailyReportScheduler } from './src/services/statistics-service.js';
import { generateNewmanStyleBinaryReport, convertBinaryToScenarioResult, generateBinaryHtmlReport, generateSimpleBatchReport } from './src/services/report-generator.js';
import { spawnNewmanCLI, getBinaryPath, spawnBinaryCLI } from './src/runners/spawn-helpers.js';
...
// readCfg, nowInTZString, kstTimestamp, reportsDir, logsDir → src/utils/config.js, src/utils/time.js에서 import

// state, registerRunningJob, unregisterRunningJob, broadcastRunningJobs → src/state/running-jobs.js에서 import
...
// finalizeJobCompletion → src/state/running-jobs.js에서 import
...
// SSE 관련 함수/변수 → src/utils/sse.js에서 import
// broadcastState ~ buildNewmanFailureReport → 모듈로 이동됨 (src/utils/sse.js, src/parsers/newman-parser.js, src/services/*)
...
// unifiedClients → src/utils/sse.js에서 import
...
// Schedules
// schedFile, schedules, loadSchedules, saveSchedules, processSchedule → src/services/schedule-service.js에서 import
...
// processSchedule → src/services/schedule-service.js로 이동
...
// spawn
// spawnNewmanCLI, getBinaryPath, spawnBinaryCLI → src/runners/spawn-helpers.js에서 import

// parseBinaryOutput ~ generateSummary → 모듈로 이동됨 (src/parsers/*, src/utils/crypto.js, src/services/alert-integration.js)
...
app.get('/api/run/:name', async (req,res)=>{
  ...
  try {
    // 같은 이름의 job이 이미 실행 중인지 체크 (다른 job은 허용)
...
// getTodayStatsInternal, getJobServiceMap, sendDailyReport, setupDailyReportScheduler → src/services/statistics-service.js에서 import
...
// generateNewmanStyleBinaryReport, convertBinaryToScenarioResult, generateBinaryHtmlReport → src/services/report-generator.js에서 import
...
// matchPattern → src/utils/debug.js에서 import
// generateSimpleBatchReport → src/services/report-generator.js에서 import
